...
// so they fail in any fork that uses the documented seam (here: Resparkable's
// fourteen). Stubbing it keeps this suite measuring what it claims to.
//
// Local patch to a Resparkable-owned test. Filed upstream as
// https://github.com/human-centric-engineering/sunrise/issues/525; remove this
// stub when it lands. Ask #25 in `.context/framework/resparkable/sunrise-asks.md`.
