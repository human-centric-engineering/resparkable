...
const ALLOWED_CALL_SITES: readonly string[] = [
  ...
  'app/api/v1/resparkable/transcribe/route.ts | agentId=agent.id | conversationId=— | workflowExecutionId=—',
  'app/api/v1/resparkable/transcribe/image/route.ts | agentId=agent.id | conversationId=— | workflowExecutionId=—',
  ...
  'lib/framework/resparkable/services/ideate.ts | agentId=spread((agent?.id ? { agentId: agent.id } : {})) | conversationId=— | workflowExecutionId=—',
