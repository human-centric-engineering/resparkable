...
| Sharing (access layer)   | `.context/framework/resparkable/sharing.md`               | D5's two layers (`repo/**` owner queries vs `access/**` shared queries), grants and public links, the owner short-circuit, per-basis redaction, the cascade and the filter-board trap |
