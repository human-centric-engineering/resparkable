/**
 * The Resparkable platform version this checkout corresponds to.
 *
 * SOURCE OF TRUTH for the Resparkable version. Do NOT derive this from
 * `package.json.version` — forks edit that with their own app's version, and
 * Resparkable's version would silently follow the fork's. The fork's app version
 ...
 * version commits to.
 *
 * Bumped by Resparkable maintainers as part of cutting a release (one-line edit
 ...
 *   published issues — for every Resparkable-derived deployment, not just one.
 *   It is served from `GET /api/v1/admin/stats` as `system.resparkableVersion`
 ...
 */
export const RESPARKABLE_VERSION = '0.11.2';
