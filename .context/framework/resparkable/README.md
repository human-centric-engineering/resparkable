...
| Capabilities                            | `lib/app/capabilities.ts` → `registerResparkableCapabilities()` (twenty-one; fourteen in 6b, three in 7, the stale digest in 8, capture-for-token in 9, capture-context and get-context-digest in Release 8 phase 39)                                                                                                                                                          |
