 ...
 * beside the Resparkable platform version it was built on, plus the Node version and
 * environment.
 *
 ...
 * `tests/unit/resparkable-version-disclosure.test.ts` is what checks that.
 *
 ...
 * without `resparkableVersion` type-checks all the way to here and would render a
      ...
      <CardContent>
        {stats?.system ? (
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            {/*
              "Resparkable platform", not "Resparkable". Upstream `BRAND.name` IS
              the product name, so a bare label collides with the app row and the card
              reads "Resparkable 0.9.0 · Resparkable 0.9.0" — two identical labels over
              ...
              fork has rebranded.
            */}
            <InfoItem label="Resparkable platform" value={stats.system.resparkableVersion} />
