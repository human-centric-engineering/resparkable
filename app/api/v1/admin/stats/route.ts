...
// version, derived from package.json via `lib/app-version.ts`; RESPARKABLE_VERSION
...
// RESPARKABLE_VERSION. It used to be on the unauthenticated `/api/health` payload
...
export const GET = withAdminAuth(async (request, session) => {
  ...
  const stats: SystemStats = {
    ...
    system: {
      ...
      resparkableVersion: RESPARKABLE_VERSION,
